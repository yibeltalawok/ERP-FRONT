...
var TextArea = /** @class */ (function (_super) {
    ...
    TextArea.prototype.render = function () {
        ...
        // eslint-disable-next-line deprecation/deprecation
        growVertically = _b.growVertically, inputRef = _b.inputRef, intent = _b.intent, large = _b.large, small = _b.small, htmlProps = __rest(_b, ["asyncControl", "autoResize", "className", "fill", "growVertically", "inputRef", "intent", "large", "small"]);
        var rootClasses = classNames(Classes.INPUT, Classes.TEXT_AREA, Classes.intentClass(intent), (_a = {},
