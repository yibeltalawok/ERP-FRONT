...
@pt-dark-app-background-color: #252a31;
...
@pt-text-selection-color: rgba(125, 188, 255, 60%);
...
@pt-dark-divider-white-muted: rgba(255, 255, 255, 0.1);
...
@pt-font-size: 10px * 1.4;
@pt-font-size-large: 10px * 1.6;
@pt-font-size-small: 10px * 1.2;

@pt-line-height: 1.28581;

@pt-border-radius: 2px;

@pt-button-height: 10px * 3;
@pt-button-height-small: 10px * 2.4;
@pt-button-height-smaller: 10px * 2;
@pt-button-height-large: 10px * 4;

@pt-input-height: 10px * 3;
@pt-input-height-large: 10px * 4;
@pt-input-height-small: 10px * 2.4;

@pt-navbar-height: 10px * 5;

@pt-z-index-base: 0;
@pt-z-index-content: 0 + 10;
@pt-z-index-overlay: 0 + 10 + 10;
@pt-z-index-dialog-header: 0 + 10 + 10 + 10;

@pt-border-shadow-opacity: 0.1;
@pt-drop-shadow-opacity: 0.2;
@pt-dark-border-shadow-opacity: 0.1 * 2;
@pt-dark-drop-shadow-opacity: 0.2 * 2;
...
@pt-dark-elevation-shadow-0: inset 0 0 0 1px rgba(255, 255, 255, 0.2);
@pt-dark-elevation-shadow-1:
  inset 0 0 0 1px rgba(255, 255, 255, 0.2),
  0 1px 1px 0 rgba(17, 20, 24, 0.2 * 2);
@pt-dark-elevation-shadow-2:
  inset 0 0 0 1px rgba(255, 255, 255, 0.2),
  0 1px 1px rgba(17, 20, 24, 0.2 * 2),
  0 2px 6px rgba(17, 20, 24, 0.2 * 2);
...
@pt-dark-elevation-shadow-4:
  ...
  0 18px 46px 6px rgba(17, 20, 24, 0.2 * 2);
