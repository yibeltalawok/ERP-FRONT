...
export const PanelStack2 = (props) => {
    ...
    const [localStack, setLocalStack] = React.useState(initialPanel !== undefined ? [initialPanel] : []);
    const stack = React.useMemo(() => (isControlled ? propsStack.slice().reverse() : localStack), [localStack, isControlled, propsStack]);
