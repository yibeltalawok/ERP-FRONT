...
export const AnchorButton = React.forwardRef((props, ref) => {
    ...
    return (React.createElement("a", { role: "button", ...removeNonHTMLProps(props), ...commonProps, "aria-disabled": commonProps.disabled, href: commonProps.disabled ? undefined : href, tabIndex: commonProps.disabled ? -1 : tabIndex }, renderButtonContents(props)));
});
...
function useSharedButtonAttributes(props, ref) {
    const { active = false, alignText, fill, large, loading = false, minimal, onBlur, onKeyDown, onKeyUp, outlined, small, tabIndex, } = props;
    ...
    const className = classNames(Classes.BUTTON, {
        ...
        [Classes.SMALL]: small,
    }, Classes.alignmentClass(alignText), Classes.intentClass(props.intent), props.className);
    return {
        className,
        disabled,
        onBlur: handleBlur,
