...
export const HotkeysProvider = ({ children, dialogProps, renderDialog, value }) => {
    ...
    const dialog = renderDialog?.(state, { handleDialogClose }) ?? (React.createElement(HotkeysDialog2, { ...dialogProps, isOpen: state.isDialogOpen, hotkeys: state.hotkeys, onClose: handleDialogClose }));
