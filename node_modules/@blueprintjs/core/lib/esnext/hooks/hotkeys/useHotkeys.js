...
export function useHotkeys(keys, options = {}) {
    ...
    const invokeNamedCallbackIfComboRecognized = React.useCallback((global, combo, callbackName, e) => {
    ...
    const handleGlobalKeyUp = React.useCallback((e) => invokeNamedCallbackIfComboRecognized(true, getKeyCombo(e), "onKeyUp", e), [invokeNamedCallbackIfComboRecognized]);
    const handleLocalKeyDown = React.useCallback((e) => invokeNamedCallbackIfComboRecognized(false, getKeyCombo(e.nativeEvent), "onKeyDown", e.nativeEvent), [invokeNamedCallbackIfComboRecognized]);
    const handleLocalKeyUp = React.useCallback((e) => invokeNamedCallbackIfComboRecognized(false, getKeyCombo(e.nativeEvent), "onKeyUp", e.nativeEvent), [invokeNamedCallbackIfComboRecognized]);
    React.useEffect(() => {
