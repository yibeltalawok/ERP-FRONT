...
function useAsyncControllableValue(props) {
    ...
    var _b = React.useState(propValue), nextValue = _b[0], setNextValue = _b[1];
    ...
    var _d = React.useState(false), hasPendingUpdate = _d[0], setHasPendingUpdate = _d[1];
    ...
    var createOnCancelPendingCompositionEnd = React.useCallback(function () {
        var timeoutId = window.setTimeout(function () { return setIsComposing(false); }, exports.ASYNC_CONTROLLABLE_VALUE_COMPOSITION_END_DELAY);
