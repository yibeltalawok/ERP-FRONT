...
var hotkeys_1 = require("../components/hotkeys");
var hotkeyParser_1 = require("../components/hotkeys/hotkeyParser");
var hotkeysDialogLegacy_1 = require("./hotkeysDialogLegacy");
var SHOW_DIALOG_KEY = "?";
var HotkeyScope;
(function (HotkeyScope) {
    HotkeyScope["LOCAL"] = "local";
    HotkeyScope["GLOBAL"] = "global";
})(HotkeyScope || (exports.HotkeyScope = HotkeyScope = {}));
var HotkeysEvents = /** @class */ (function () {
    function HotkeysEvents(scope) {
        ...
        this.handleKeyDown = function (e) {
            ...
            if (!isTextInput && (0, hotkeyParser_1.comboMatches)((0, hotkeyParser_1.parseKeyCombo)(SHOW_DIALOG_KEY), combo)) {
                if ((0, hotkeysDialogLegacy_1.isHotkeysDialogShowing)()) {
                    ...
                    (0, hotkeysDialogLegacy_1.showHotkeysDialog)(_this.actions.map(function (action) { return action.props; }));
                }
                return;
            }
            else if ((0, hotkeysDialogLegacy_1.isHotkeysDialogShowing)()) {
                return;
            }
        ...
        this.handleKeyUp = function (e) {
            ...
            _this.invokeNamedCallbackIfComboRecognized((0, hotkeyParser_1.getKeyCombo)(e), "onKeyUp", e);
        };
    }
    ...
    HotkeysEvents.prototype.setHotkeys = function (props) {
        ...
        react_1.Children.forEach(props.children, function (child) {
            if ((0, utils_1.isElementOfType)(child, hotkeys_1.Hotkey) && _this.isScope(child.props)) {
                actions.push({
