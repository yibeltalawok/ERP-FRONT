...
var hotkeysReducer = function (state, action) {
    switch (action.type) {
        case "ADD_HOTKEYS":
            ...
            return tslib_1.__assign(tslib_1.__assign({}, state), { hotkeys: tslib_1.__spreadArray(tslib_1.__spreadArray([], state.hotkeys, true), newUniqueHotkeys, true) });
        case "REMOVE_HOTKEYS":
...
var HotkeysProvider = function (_a) {
    ...
    var fallbackReducer = React.useReducer(hotkeysReducer, tslib_1.__assign(tslib_1.__assign({}, initialHotkeysState), { hasProvider: true }));
