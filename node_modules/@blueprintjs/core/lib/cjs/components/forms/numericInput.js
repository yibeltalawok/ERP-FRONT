...
var NumericInput = /** @class */ (function (_super) {
    ...
    function NumericInput() {
        ...
        _this.numericInputId = common_1.Utils.uniqueId("numericInput");
        _this.state = {
        ...
        _this.getCurrentValueAsNumber = function () { return Number((0, numericInputUtils_1.parseStringToStringNumber)(_this.state.value, _this.props.locale)); };
    ...
    NumericInput.prototype.render = function () {
        ...
        var containerClasses = (0, classnames_1.default)(common_1.Classes.NUMERIC_INPUT, (_a = {}, _a[common_1.Classes.LARGE] = large, _a[common_1.Classes.SMALL] = small, _a), className);
    ...
    NumericInput.prototype.renderButtons = function () {
        ...
        return (React.createElement(buttonGroup_1.ButtonGroup, { className: common_1.Classes.FIXED, key: "button-group", vertical: true },
            React.createElement(buttons_1.Button, tslib_1.__assign({ "aria-label": "increment", "aria-controls": this.numericInputId, disabled: disabled || isIncrementDisabled, icon: React.createElement(icons_1.ChevronUp, null), intent: intent }, this.incrementButtonHandlers)),
            React.createElement(buttons_1.Button, tslib_1.__assign({ "aria-label": "decrement", "aria-controls": this.numericInputId, disabled: disabled || isDecrementDisabled, icon: React.createElement(icons_1.ChevronDown, null), intent: intent }, this.decrementButtonHandlers))));
    };
    ...
    NumericInput.prototype.getButtonEventHandlers = function (direction) {
        ...
        return {
            ...
            onKeyDown: function (evt) {
                if (!_this.props.disabled && common_1.Utils.isKeyboardClick(evt)) {
