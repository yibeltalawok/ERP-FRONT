...
var NonIdealState = /** @class */ (function (_super) {
    ...
    NonIdealState.prototype.render = function () {
        ...
        return (React.createElement("div", { className: (0, classnames_1.default)(common_1.Classes.NON_IDEAL_STATE, "".concat(common_1.Classes.NON_IDEAL_STATE, "-").concat(layout), className) },
    ...
    NonIdealState.prototype.maybeRenderVisual = function () {
        ...
        if (icon == null) {
            ...
            return (React.createElement("div", { className: common_1.Classes.NON_IDEAL_STATE_VISUAL, style: { fontSize: "".concat(iconSize, "px"), lineHeight: "".concat(iconSize, "px") } },
    ...
    NonIdealState.prototype.maybeRenderText = function () {
        ...
        if (title == null && description == null) {
            ...
            return (React.createElement("div", { className: common_1.Classes.NON_IDEAL_STATE_TEXT },
                title && React.createElement(html_1.H4, null, title),
                description && (0, utils_1.ensureElement)(description, "div")));
        }
    };
    NonIdealState.displayName = "".concat(common_1.DISPLAYNAME_PREFIX, ".NonIdealState");
